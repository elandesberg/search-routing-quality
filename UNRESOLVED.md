...
| U-002 | P0 | Phase B | OPEN | Phase A evidence has not been reviewed | Produce the Phase A artifacts and record the human-gate decision below | Unassigned | None |
| U-003 | P1 | Publication | OPEN | Private destination and deployed access policy are unverified | Record the destination URL, access test, approver, and date | Unassigned | None |
| U-004 | P1 | Phase B | OPEN | Final repository URL for the simulation/replication link is unknown | Record the stable private/internal URL | Unassigned | None |
...
authorizes specialization of `docs/index.html`.
